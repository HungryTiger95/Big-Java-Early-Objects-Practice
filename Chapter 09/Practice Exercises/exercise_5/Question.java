...
public class Question
{
	...
	/**
	 * Adds text to the question answer. This method appends text to the answer text
	 * field of this object.
	 * 
	 * For Use with ChoiceQuestion class and all subclasses of that class.
	 * @param answerText the text to append to the answerText 
	 */
