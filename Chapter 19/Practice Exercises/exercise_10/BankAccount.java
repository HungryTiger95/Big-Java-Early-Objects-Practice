 ...
 *
 */
public class BankAccount implements Measurable<BankAccount>, Comparable<BankAccount>
{
	// Instance Variables
	private double balance;
	public static int previousAccountNumber = 1000;	// This variable belongs to this class not an instance of this class
	...
	public double getMeasure(BankAccount account)
	{
