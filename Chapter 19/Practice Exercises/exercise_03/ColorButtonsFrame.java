...
public class ColorButtonsFrame extends JFrame
{
	...
	public void createControlPanel()
	{
		...
		redButton = createRadioButton("RED");
		blueButton = createRadioButton("BLUE");
		greenButton = createRadioButton("GREEN");
	...
	class ClickListener implements ActionListener
	{
		...
		{
			if(redButton.isSelected()) { backgroundColor = Color.red; }
			else if(greenButton.isSelected()) { backgroundColor = Color.green; }
			else if(blueButton.isSelected()) { backgroundColor = Color.blue; }
